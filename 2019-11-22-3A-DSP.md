...
```
La teoria del campionamento elaboratada da Shannon definisce la frequenza minima necessaria per campionare un segnale analogico senza perdere informazioni ; dunque la frequenza minima deve essere maggiore del doppio della sua frequenza massima.
